...
public class NBTFoodRegistry {
	...
	private Dictionary<String, ArrayList<Object>> Pizza_ADD = dict("pepperoni", "extrafood:pizzaPepperoni", is(Items.apple), "fish", "extrafood:pizzaFish", is(Items.cooked_fish), "olives", "extrafood:pizzaOlive", is(Items.golden_apple), "cheese", "extrafood:pizzaCheese", is(ItemLoader.cheeseWheel));
