...
ArrayList<ArrayList<Object>> p3r = new ArrayList<ArrayList<Object>>();
 ...
 public BTPageGUI(String pagename, Boolean multipg, int multiplePG) {
	...
	this.irender = new RenderItem(null, null);
	pagen = pagename;
    ...
    for (ItemStack i : ExtraFood.instance.crafterPage.getArray((String) args.get(0).toString())){	
    	if (items != null){
			...
			GL11.glDisable(GL11.GL_LIGHTING);
				...
				this.irender.renderItemOverlays(this.fontRendererObj, items[9], x1 + 16, y1 - 33);
			GL11.glEnable(GL11.GL_LIGHTING);	
			}
			GL11.glDisable(GL11.GL_LIGHTING);
	...
	for (ItemStack i : ExtraFood.instance.crafterPage.getArray((String) args.get(0).toString())){
		if (i != null){
			...
			GL11.glDisable(GL11.GL_LIGHTING);
				...
				this.irender.renderItemOverlays(this.fontRendererObj, items[9], x1 + 19, y1 - 44);
			GL11.glEnable(GL11.GL_LIGHTING);	
			}
