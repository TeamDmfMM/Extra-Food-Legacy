...
public class CRPageCraftGet {
	...
	public CRPageCraftGet() {
		...
		this.putRecipe("cheesepress", new Object[] {"ipi", "ibi", "sss", 'i', Item.ingotIron, 'p', Block.planks, 'b', Item.bucketEmpty, 's', Block.stoneSingleSlab}, new ItemStack(BlockLoader.cheesePress));
